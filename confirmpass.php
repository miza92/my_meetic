...
class register
{
    public function inscription()
    {
        ...
        if ($_POST["password-confirmation"] != $_POST["password"]){
            ...
            echo "Les 2 mots de pas sont pas identiques";
        ...
        if (isset($_POST['username']) && !empty($_POST["username"]) 
            ...
            $sql = $database->prepare('INSERT INTO users (username, display_name, password, email, birthdate) VALUES (:username, :display_name, :password, :email, :birthdate)');
            ...
            ':password' => $password_hash, ':email' => $email, ':birthdate' => $birthdate]);
        }
    }
}
